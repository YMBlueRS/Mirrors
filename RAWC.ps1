...
{   
    <#
        ...
        .EXAMPLE  
            Invoke-RAWC user.pfx -Domain CORP.LOCAL
        ...
        .EXAMPLE
            Invoke-RAWC user.pfx -Domain CORP.LOCAL -Password password123
         ...
         .EXAMPLE
            Invoke-RAWC user.pfx -Domain CORP.LOCAL -Command cmd.exe
         ...
         .EXAMPLE
            Invoke-RAWC user.pfx -Domain CORP.LOCAL -PatchLsass
    ...
    try {
        ...
        [RAWC]::RunAs($Certificate, $Domain, $Password, $Command, $PatchLsass.IsPresent, $DbgHelpPath);
    } catch {
        throw
    } finally {
        if (!$PatchLsass.IsPresent) {
